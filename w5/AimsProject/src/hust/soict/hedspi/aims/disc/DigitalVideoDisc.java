...
public class DigitalVideoDisc {
    ...
    // tim kiem tu xuat hien trong xau, dung tra ve true, sai tra ve false
    public boolean search(String title) {
        boolean test = false;
        String[] gTitle = title.split(" +");
        for (String wTitle : gTitle) {
            if (this.title.toUpperCase().contains(wTitle.toUpperCase()))
                test = true;
        }
        return test;
